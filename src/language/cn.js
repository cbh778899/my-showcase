...
const cn = {
    ...
    // stock
    'operator-not-valid': '当前登录的操作员无法操作',
    'item-name-invalid': '物品名称格式错误',
    'unit-price-invalid': '单价格式错误',
    'item-stock-invalid': '物品库存格式错误',
    'add-item-success': '添加物品成功',
    'add-item-failed': '添加物品失败, 可能存在重名物品',
    'Item ID': '物品ID',
    'Item Name': '物品名称',
    'Unit Price': '物品单价',
    'Item Stock': '物品库存',
    'rm-operator-success': '移除操作员成功',
    'rm-operator-failed': '移除操作员失败',
    'copy-password-success': '成功复制密码！',
    'click-to-add-operator': '点击以添加操作员',
    'Not Removable': '不可移除',
    'Operator ID': '操作员ID',
    'Operator Name': '操作员姓名',
    'Remove Operator': '移除操作员',
    'Operator Password': '操作员密码',
    'Admin Password': '系统管理员密码',
    'Auto generated': '自动生成',
    'confirm-remove-operator': name=>`您确认要移除操作员${name}吗？`,
    'ask-select-operator-to-remove': '请选择需要移除的操作员',
    'auto-gen-password-is': '自动生成的密码为:',
    'copy-password': '复制密码',
    'admin-password-incorrect': '管理员密码错误',
    'operator-password-incorrect': '操作员密码错误',
    'operator-password-rules': '密码应为8-32位数字、字母以及符号的组合',
    'update-operator-password-success': '成功更新操作员的密码',
    'switch-login-type': '切换登录管理员/操作员账号',
    'ask-op-new-password': '您的密码需要重置，请输入新密码',
    'Operator Login': '登录操作员账号',
    'System Operator': '系统管理员',
    'Manage Operators': '管理操作员',
    'Add Item': '添加物品',
    'Sale': '售出',
    'Logout Current Operator': '登出当前操作员',
    'Displaying Stock': '正在展示库存物品',
    'no-stock': '当前没有任何库存！',
    'Last Page': '上一页',
    'Next Page': '下一页',
