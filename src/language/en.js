...
const en = {
    ...
    // stock
    'operator-not-valid': 'Current logged in operator is invalid for this action.',
    'item-name-invalid': 'Item name is invalid!',
    'unit-price-invalid': 'Unit price is invalid, should be a number.',
    'item-stock-invalid': 'Item stock is invalid, should be a number',
    'add-item-success': 'Successfully added item',
    'add-item-failed': 'Add item failed, there might be an item with the same name',
    'rm-operator-success': 'Successfully removed operator',
    'rm-operator-failed': 'Remove operator failed!',
    'copy-password-success': 'Successfully copied operator password',
    'click-to-add-operator': 'Click to create new operator',
    'confirm-remove-operator': name=>`Are you sure you want to remove operator ${name}?`,
    'ask-select-operator-to-remove': 'Please select the operator to remove',
    'auto-gen-password-is': 'The auto-generated password is:',
    'copy-password': 'Copy password',
    'admin-password-incorrect': 'Administrator password is incorrect!',
    'operator-password-incorrect': 'Operator password is incorrect!',
    'operator-password-rules': 'Password should contains 8-32 digit number, letter and special character.',
    'update-operator-password-success': 'Successfully updated operator password!',
    'switch-login-type': 'Switch login as administrator/operator',
    'ask-op-new-password': 'Your password need to be reset, please input a new password',
